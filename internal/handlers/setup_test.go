...
func getRoutes() http.Handler {
	...
	mux.Get("/anufor-embassy", Repo.Anufor)
	mux.Get("/mulang-quarters", Repo.Mulang)
	mux.Get("/tawah-house", Repo.Tawah)
	mux.Get("/anyere-john-suite", Repo.Anyere)
	mux.Get("/ayafor-residence", Repo.Ayafor)
